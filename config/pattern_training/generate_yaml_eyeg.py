...
gamma_results_stage_1 = {
    ...
    ('Big_Nose', 'fairness constraint'): 1,
    ('Big_Nose', 'perturbed fairness constraint'): 10,
    ('Big_Nose', 'EquiMask fairness constraint'): 1,
    ('Big_Nose', 'EquiMask perturbed fairness constraint'): 0.1,
    ('Bags_Under_Eyes', 'fairness constraint'): 10,
    ('Bags_Under_Eyes', 'perturbed fairness constraint'): 5,
    ('Bags_Under_Eyes', 'EquiMask fairness constraint'): 1,
    ('Bags_Under_Eyes', 'EquiMask perturbed fairness constraint'): 1,
    ('High_Cheekbones', 'fairness constraint'): 5,
    ('High_Cheekbones', 'perturbed fairness constraint'): 10,
    ('High_Cheekbones', 'EquiMask fairness constraint'): 10,
    ('High_Cheekbones', 'EquiMask perturbed fairness constraint'): 5,
    ('Oval_Face', 'fairness constraint'): 10,
    ('Oval_Face', 'perturbed fairness constraint'): 5,
    ('Oval_Face', 'EquiMask fairness constraint'): 5,
